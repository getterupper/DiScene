...
teacher_weight = 'checkpoints/teacher_vanilla.pth'  # NOTE:  modify it to /path/to/your/teacher/model
...
teacher_model = dict(
    ...
    pts_bbox_head=dict(
        type='DiSceneHead_Teacher_Vanilla',
...
model = dict(
    ...
    img_neck=img_neck,
    pts_bbox_head=dict(
        type='DiSceneHead_Distill_Vanilla',
        num_classes=len(occ_names),
        in_channels=embed_dims,
        num_query=num_query,
        pc_range=point_cloud_range,
