...
class DiSceneTransformer(BaseModule):
    def __init__(self,
                 embed_dims,
                 num_frames=8,
                 num_views=1,
        ...
        self.decoder = DiSceneTransformerDecoder(
...
class DiSceneTransformerDecoder(BaseModule):
    def __init__(self,
                 embed_dims,
                 num_frames=8,
                 num_views=1,
        ...
        for i in range(num_layers):
            self.decoder_layers.append(
                DiSceneTransformerDecoderLayer(
...
class DiSceneTransformerDecoderLayer(BaseModule):
    def __init__(self,
                 embed_dims,
                 num_frames=8,
                 num_views=1,
        ...
        self.self_attn = DiSceneSelfAttention(
            embed_dims, num_heads=8, dropout=0.1, pc_range=pc_range)
        self.sampling = DiSceneSampling(embed_dims, num_frames=num_frames, num_views=num_views,
                                     num_groups=num_groups, num_points=num_points, 
                                     num_levels=num_levels, pc_range=pc_range)
        self.mixing = DiSceneAdaptiveMixing(in_dim=embed_dims, in_points=num_points * num_frames,
...
class DiSceneSelfAttention(BaseModule):
...
class DiSceneSampling(BaseModule):
...
class DiSceneAdaptiveMixing(nn.Module):
    """Adaptive Mixing"""
