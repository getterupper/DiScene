...
class DiScene_Distill_Vanilla(MVXTwoStageDetector):
    def __init__(self,
                 use_grid_mask=True,
                 data_aug=None,
                 stop_prev_grad=0,
    ...
    def forward_train(self,
        ...
        prior_outs = self.pts_bbox_head.forward_anchors(prior_src_feats, img_metas, teacher_prior_points)
        ...
        anchor_outs = self.pts_bbox_head.forward_anchors(anchor_src_feats, img_metas, anchor_points)
        teacher_anchor_outs = self.teacher_model.pts_bbox_head.forward_anchors(anchor_tgt_feats, img_metas, anchor_points)
